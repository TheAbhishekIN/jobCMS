...
$(document).ready(function(){
	...
	$(".keywords-container").each(function() {
		...
		function addKeyword() {
			count++;
			var $newKeyword = $("<span class='keyword'><span class='keyword-remove'></span><span class='keyword-text'>"+ keywordInput.val() +"</span></span><input type='hidden' name='tags["+count+"]' value='"+ keywordInput.val() +"'>");
